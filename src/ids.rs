...
pub const PKG_017: &str = "PKG-017"; // uncommon file extension on an EPUB 2 book (warning)
pub const PKG_018: &str = "PKG-018"; // the input file does not exist (CLI-level)
...
pub const PKG_023: &str = "PKG-023"; // a validation profile was requested for an EPUB 2 book (usage)
pub const PKG_024: &str = "PKG-024"; // uncommon file extension on an EPUB 3 book (usage)
...
pub const OPF_016: &str = "OPF-016"; // a <rootfile> in container.xml has no full-path attribute
pub const OPF_017: &str = "OPF-017"; // a <rootfile>'s full-path attribute is empty
...
pub const OPF_047: &str = "OPF-047"; // the package document uses legacy OEBPS 1.2 syntax (warning)
pub const OPF_038: &str = "OPF-038"; // an OEBPS 1.2 package uses a modern content media-type (warning)
pub const OPF_039: &str = "OPF-039"; // an OEBPS 1.2 package uses a modern stylesheet media-type (warning)
...
pub const OPF_064: &str = "OPF-064"; // a dc:type selected the validation profile (info)
